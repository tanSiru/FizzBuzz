# CSC207 Week 1 Lab Activity: Fizz Buzz!(test change for git pull)
...
- Both uses the keyword for
- In Java, you need to explicitly define i as an int
- In Java, you need to specify i++
- Python uses colons while java uses curly brackets
- You need to explicitly define the type of your variables
